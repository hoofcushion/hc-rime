...
return {
 ...
 filter_symbol        ={accept="Shift+Control+"..shift[3],toggle="filter_zhuyin",when="always"},
 filter_zhuyin        ={accept="Shift+Control+"..shift[4],toggle="filter_huoxin",when="always"},
 filter_huoxin        ={accept="Shift+Control+"..shift[5],toggle="filter_symbol",when="always"},
