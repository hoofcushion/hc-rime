return {
 ascii_mode           ={name="ascii_mode",reset=0,states={"汉","英"}},
 ascii_punct          ={name="ascii_punct",reset=nil,states={"，，",",."}},
 full_shape           ={name="full_shape",reset=nil,states={"半","全"}},
 filter_simplification={name="filter_simplification",reset=0,states={"关","开"}},
